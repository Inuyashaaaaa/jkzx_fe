...
const uploadData = {
  ...
  //   if (file.type === 'application/msword' || file.type === 'image/png') {
  ...
  // onPreview: file => {
  //   // location.href = `${downloadUrl}${file.response.result.uuid}&partyDoc=true`;
  //   window.open(
  //     `http://10.1.100.197:16016${downloadFileUrl}${file.response.result.uuid}&partyDoc=true`
  //   );
  // },
};
