...
class RiskManagerIntradayExpiringPositionReport extends PureComponent implements ISourceTable {
    ...
    return (
      <PageHeaderWrapper title="到期合约">
        <Row type="flex" justify="end" style={{ marginBottom: VERTICAL_GUTTER }}>
          <ReloadGreekButton fetchTable={this.fetch} id="real_time_expiring_position_dag" />
        </Row>
        <SourceTable
...
export default socketHOC(RiskManagerIntradayExpiringPositionReport);
