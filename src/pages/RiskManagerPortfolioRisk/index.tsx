...
// class RiskManagerPortfolioRisk extends PureComponent implements ISourceTable {
...
//       loading: true,
//     });
//     const { error, data } = await rptIntradayPortfolioRiskReportPaged({
...
//           unionId={'RiskManagerPortfolioRisk'}
//           defaultColDef={{
...
// export default socketHOC(RiskManagerPortfolioRisk);
...
const RiskManagerPortfolioRisk = memo<any>(props => {
  return (
    <Modal
      ...
      searchMethod={rptIntradayPortfolioRiskReportPaged}
      downloadName={'投资组合风险'}
      scrollWidth={1350}
      hideReload={true}
    />
