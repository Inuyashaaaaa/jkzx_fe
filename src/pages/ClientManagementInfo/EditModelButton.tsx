import {
  ...
  import { Button, Cascader, Divider, Icon, Row, Steps, Tabs } from 'antd';
  ...
  const CreateModalButton = memo<any>(props => {
    const { salesCascaderList, name, record } = props;
    ...
    const fetchTableData = async () => {
        const { error, data } = await clientAccountDel({ accountId: record.accountId });
    }
