...
import {
  rptFinancialOtcFundDetailReportPagedByNameAndDate,
  rptReportNameList,
...
class ReportsFundsDetailedStatements extends PureComponent {
  ...
  public fetchTable = async () => {
    ...
    const { error, data } = await rptFinancialOtcFundDetailReportPagedByNameAndDate({
