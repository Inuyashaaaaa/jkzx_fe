...
import { isType, notType, delay } from '@/utils';
import SearchTableBase from '@/components/_SearchTable/base';
import { SearchTable as types } from '@/components/_SearchTable/type';
