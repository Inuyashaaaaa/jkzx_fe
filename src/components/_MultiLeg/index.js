...
import EditVerticalTable from '@/components/EditVerticalTable';
import styles from '@/components/_MultiLeg/index.less';
import { MultiLeg as types } from '@/components/_MultiLeg/types';
import StandardForm from '@/components/_StandardForm';
import { allLeg } from '@/constants/leg';
import { assert, getArray, mapDeep } from '@/utils';
