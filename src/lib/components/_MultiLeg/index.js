...
import EditVerticalTable from '@/lib/components/_EditVerticalTable';
import styles from '@/lib/components/_MultiLeg/index.less';
import { MultiLeg as types } from '@/lib/components/_MultiLeg/types';
import StandardForm from '@/lib/components/_StandardForm';
import { allLeg } from '@/constants/leg';
import { assert, getArray, mapDeep } from '@/lib/utils';
