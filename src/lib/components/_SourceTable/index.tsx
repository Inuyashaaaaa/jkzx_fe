import { isShallowEqual, remove, securityCall } from '@/lib/utils';
...
class SourceTable extends PureComponent<SourceTableProps, SourceTableState> {
  ...
  public getFunctionTableColumnDefs = memo((tableColumnDefs, stationalData) => {
  ...
  public getCreateFormControls = memo((createFormControls, stationalData) => {
  ...
  public getSearchFormControls = memo((searchFormControls, stationalData) => {
