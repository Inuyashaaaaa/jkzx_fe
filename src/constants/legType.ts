import { LEG_FIELD } from './common';

export const DATE_LEG_FIELDS = [
...
export const LEG_FIELD_ORDERS = [
  ...
  LEG_FIELD.CURRENCY,
  LEG_FIELD.PAYMENT_AMOUNT,
  LEG_FIELD.PAYMENT_DIRECTION,
  LEG_FIELD.PAYMENT_STATE,
  ...
  LEG_FIELD.STD_DELTA,
  LEG_FIELD.DELTA,
  LEG_FIELD.DELTA_CASH,
  LEG_FIELD.GAMMA,
  LEG_FIELD.GAMMA_CASH,
  LEG_FIELD.VEGA,
  LEG_FIELD.THETA,
  LEG_FIELD.RHO_R,
  LEG_FIELD.CEGA,
