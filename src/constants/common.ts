...
export const MARGIN_STATUS_TYPE_MAP = {
  UNKNOWN: 'UNKNOWN',
  NORMAL: 'NORMAL',
  NOT_ENOUGH: 'NOT_ENOUGH',
  PENDING_MARGIN_CALL: 'PENDING_MARGIN_CALL',
};

export const MARGIN_STATUS_TYPE_ZHCN_MAP = {
  UNKNOWN: '未知',
  NORMAL: '正常',
  NOT_ENOUGH: '保证金不足',
...
export const MARGIN_STATUS_TYPE_OPTIONS = convertOptions(
  MARGIN_STATUS_TYPE_MAP,
  MARGIN_STATUS_TYPE_ZHCN_MAP
);

export const PAYMENT_DIRECTION_TYPE_MAP = {
  OUT: 'OUT',
  IN: 'IN',
};

export const PAYMENT_DIRECTION_TYPE_ZHCN_MAP = {
  OUT: '出金',
  IN: '入金',
};

export const PAYMENT_DIRECTION_TYPE_OPTIONS = convertOptions(
  PAYMENT_DIRECTION_TYPE_MAP,
  PAYMENT_DIRECTION_TYPE_ZHCN_MAP
);

export const ACCOUNT_DIRECTION_TYPE_MAP = {
  PARTY: 'PARTY',
  COUNTER_PARTY: 'COUNTER_PARTY',
};

export const ACCOUNT_DIRECTION_TYPE_ZHCN_MAP = {
  PARTY: '客户资金',
  COUNTER_PARTY: '我方资金',
};

export const ACCOUNT_DIRECTION_TYPE_OPTIONS = convertOptions(
  ACCOUNT_DIRECTION_TYPE_MAP,
  ACCOUNT_DIRECTION_TYPE_ZHCN_MAP
);

export const PROCESS_STATUS_TYPES_MAP = {
  PROCESSED: 'PROCESSED',
  UN_PROCESSED: 'UN_PROCESSED',
};

export const PROCESS_STATUS_TYPES_ZHCN_MAPS = {
  PROCESSED: '已处理',
  UN_PROCESSED: '未处理',
};

export const PROCESS_STATUS_TYPES_OPTIONS = convertOptions(
  PROCESS_STATUS_TYPES_MAP,
...
export const LEG_TYPE_ZHCH_MAP = {
  ...
  [LEG_TYPE_MAP.SPREAD_EUROPEAN]: '价差欧式',
};
...
export const IOGLOD_EVENT_TYPE_ZHCN_MAP = {
  START_TRADE: '开仓',
  UNWIND_TRADE: '平仓',
  SETTLE_TRADE: '结算',
  TRADE_CASH_FLOW: '现金流',
...
export const IOGLOD_EVENT_TYPE_OPTIONS = convertOptions(
  IOGLOD_EVENT_TYPE_MAP,
  IOGLOD_EVENT_TYPE_ZHCN_MAP
);

export const ACCOUNT_EVENT_TYPE_MAP = {
  SELLER_UNWIND_TRADE: 'SELLER_UNWIND_TRADE',
  BUYER_UNWIND_TRADE: 'BUYER_UNWIND_TRADE',
  SELLER_CHANGE_PREMIUM: 'SELLER_CHANGE_PREMIUM',
  BUYER_CHANGE_PREMIUM: 'BUYER_CHANGE_PREMIUM',
  SELLER_SETTLE_TRADE: 'SELLER_SETTLE_TRADE',
  BUYER_SETTLE_TRADE: 'BUYER_SETTLE_TRADE',
  TRADE_CASH_FLOW: 'TRADE_CASH_FLOW',
};

export const ACCOUNT_EVENT_TYPE_ZHCN_MAP = {
  SELLER_UNWIND_TRADE: '卖出期权平仓',
  BUYER_UNWIND_TRADE: '买入期权平仓',
  SELLER_CHANGE_PREMIUM: '卖出期权开仓',
  BUYER_CHANGE_PREMIUM: '买入期权开仓',
  SELLER_SETTLE_TRADE: '卖出期权结算',
  BUYER_SETTLE_TRADE: '买入期权结算',
  TRADE_CASH_FLOW: '自定义流水',
};
